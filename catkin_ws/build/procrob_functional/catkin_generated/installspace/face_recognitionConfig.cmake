...
if("FALSE" STREQUAL "TRUE")
  set(face_recognition_SOURCE_PREFIX /home/niner/catkin_ws/src/procrob_functional)
  set(face_recognition_DEVEL_PREFIX /home/niner/catkin_ws/devel)
  ...
  set(face_recognition_INSTALL_PREFIX /home/niner/catkin_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'face_recognition' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/niner/catkin_ws/install/${idir}'.  Ask the maintainer 'Pouyan Ziafati (Author) <pouyan.ziafati@uni.lu>' to fix it.")
    endif()
