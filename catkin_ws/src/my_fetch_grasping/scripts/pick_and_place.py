...
class Pick_Place:
    def __init__(self):
        ...
        self._grasp_object_name = rospy.get_param('~grasp_object_name', 'object_8')
	...
	p.pose.orientation.y = 0.025
	p.pose.orientation.z = 0.97
	p.pose.orientation.w = -0.17
