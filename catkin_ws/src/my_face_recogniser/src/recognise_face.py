...
class FaceRecogniser(object):
	...
	self.path_to_package = "/home/niner/catkin_ws/src/face_recognition_pkg"
    ...
    def camera_callback(self,data):
        ...
        image_path = os.path.join(self.path_to_package,"person_img/bindu.jpg")
        ...
        cv2.imshow("Image window", small_frame)
        cv2.waitKey(1)
